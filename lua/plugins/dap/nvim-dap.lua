	...
	config = function()
		...
		vim.keymap.set("n", "<leader>dc", function()
			...
			if vim.fn.filereadable(".vscode/launch.json") == 1 then
				vim.notify("Using .vscode/launch.json", vim.log.levels.INFO)
				vscode.json_decode = function(str)
					return vim.json.decode(json.json_strip_comments(str))
				end
				vscode.load_launchjs(nil, { cppdbg = { "c", "cpp" } })
			elseif vim.fn.filereadable(".vscode/launch.shared.json") == 1 then
				vim.notify("Using .vscode/launch.shared.json", vim.log.levels.INFO)
				vscode.json_decode = function(str)
					return vim.json.decode(json.json_strip_comments(str))
				end
				vscode.load_launchjs(".vscode/launch.shared.json", { cppdbg = { "c", "cpp" } })
			end
